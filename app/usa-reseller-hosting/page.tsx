...
export const metadata = {
  title: "USA Reseller Hosting Best Price — Start Your Hosting Business | Hostao",
...
const USA_RESELLER_PLANS = [
  {
    ...
    href: "https://my.hostao.com/store/reseller/cheap-reseller"
  },
  {
    name: "USA Reseller2",
    discount: "SAVE 40% OFF",
    ...
    href: "https://my.hostao.com/store/reseller/business-reseller"
  },
  {
    name: "USA Reseller3",
    discount: "SAVE 40% OFF", 
    ...
    href: "https://my.hostao.com/store/reseller/vip-reseller"
  },
  {
    name: "USA Reseller4",
    discount: "SAVE 40% OFF",
    ...
    href: "https://my.hostao.com/store/reseller/corporate-reseller"
  }
];

export default function USAResellerHostingPage() {
  return (
    <div className="bg-white">
      ...
      <section className="py-14 px-4 text-center" style={{ background: "#d9ecff" }}>
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 text-[#0c1434]">USA Reseller Hosting Best Price</h1>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl font-bold text-gray-900">USA Reseller Hosting Features</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: "⚡", title: "LiteSpeed WebServer", desc: "Superior performance compared to Apache - up to 3x faster" },
              { icon: "🌐", title: "CloudLinux OS", desc: "Stable and secure operating system for optimal performance" },
              { icon: "🔒", title: "Free SSL Certificates", desc: "Unlimited SSL certificates for all domains" },
